...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { text-align: center; padding: 20px 0 15px; border-bottom: 2px solid #EAB308; margin-bottom: 20px; }
        .header .logo { max-height: 60px; margin-bottom: 10px; }
        .header h1 { font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; color: #111827; }
        .header .subtitle { font-size: 11px; color: #6B7280; margin-top: 4px; }
        .header .info { font-size: 10px; color: #6B7280; margin-top: 3px; }
        .header .periode { font-size: 12px; font-weight: bold; color: #EAB308; margin-top: 8px; }
        ...
        .stat-value { font-size: 16px; font-weight: bold; color: #111827; margin-top: 4px; }

        .section-title { font-size: 13px; font-weight: bold; color: #111827; margin-bottom: 10px; padding-bottom: 5px; border-bottom: 1px solid #E5E7EB; }
        ...
        .badge-rank-1 { background: #EAB308; color: white; }
...
<body>
    ...
    <table class="stats" style="margin-bottom: 20px;">
        <tr>
            <td style="width: 33%; padding: 12px; border: 1px solid #E5E7EB; border-radius: 6px; text-align: center; background: #FFFBEB;">
                ...
                <div style="font-size: 15px; font-weight: bold; color: #111827; margin-top: 4px;">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</div>
            </td>
            <td style="width: 3%;"></td>
            <td style="width: 30%; padding: 12px; border: 1px solid #E5E7EB; border-radius: 6px; text-align: center; background: #EFF6FF;">
                ...
                <div style="font-size: 15px; font-weight: bold; color: #111827; margin-top: 4px;">{{ number_format($totalOrders, 0, ',', '.') }} Order</div>
            </td>
            <td style="width: 3%;"></td>
            <td style="width: 30%; padding: 12px; border: 1px solid #E5E7EB; border-radius: 6px; text-align: center; background: #FFF7ED;">
                ...
                <div style="font-size: 15px; font-weight: bold; color: #111827; margin-top: 4px;">Rp {{ number_format($averageOrderValue, 0, ',', '.') }}</div>
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tfoot>
            <tr>
                <td colspan="6" class="font-bold text-right" style="padding: 8px 10px; border-top: 2px solid #111827; background: #F9FAFB;">TOTAL KESELURUHAN</td>
                <td class="font-bold text-right" style="padding: 8px 10px; border-top: 2px solid #111827; background: #F9FAFB; color: #EAB308; font-size: 12px;">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</td>
            </tr>
        </tfoot>
        @endif
    </table>
